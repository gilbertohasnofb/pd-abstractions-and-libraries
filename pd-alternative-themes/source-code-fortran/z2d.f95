...
character (LEN=256) :: input, codeLine, newCodeString, auxString
character (LEN=1), dimension(9999,256) :: code
integer :: i, j, k, aux, N, lineLength, digit, counter
logical :: condition
...
open(unit=12,file=TRIM(input)//"-d.pd")
...
write(*,*) 
write(*,"(A,A,A)") "Success! A file named ", TRIM(input), "-d.pd was created in this directory"

1000 end program z2d

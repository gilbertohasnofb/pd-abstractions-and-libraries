...
do i=2,36
	...
	if (i<10) then
		write(11,"(A,I1,A)") "#X obj 301 101 hradio 15 1 0 ", i, " empty empty empty 0 -8 0 10 -179712 -1 -1 0;"
		else
			write(11,"(A,I2,A)") "#X obj 301 101 hradio 15 1 0 ", i, " empty empty empty 0 -8 0 10 -179712 -1 -1 0;"
	endif
